...
function Message({ message }) {
  ...
  const profileImage = fromMe ? profilePicture : selectedConversation.profilePicture;
    ...
    >
      ...
      {!fromMe && (
        <Avatar
          alt="User Profile"
          src={profileImage}
          sx={{ width: 30, height: 30, marginRight: fromMe ? 0 : 1, marginLeft: fromMe ? 1 : 0 }} // Smaller avatar
        />
      )}
